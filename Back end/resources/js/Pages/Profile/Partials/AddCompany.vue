    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Update your company's profile information and contact details.
            </p>
        </header>
        ...
        >
            ...
            <div>
                <InputLabel for="headquarters" value="Headquarters Address" />
                <TextInput
                    id="headquarters"
                    type="text"
                    class="mt-1 block w-full"
                    ...
                    required
                />
                <InputError class="mt-2" :message="form.errors.headquarters" />
            </div>
